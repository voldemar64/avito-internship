...
interface PostProps {
    post: {
        ...
        [key: string]: any; // Для других полей, специфичных для типа поста
    };
    onCardDelete: (post: any) => void;
    onEditButtonClick: (post: any) => void;
}

const Post: React.FC<PostProps> = ({ post, onCardDelete, onEditButtonClick }) => {
